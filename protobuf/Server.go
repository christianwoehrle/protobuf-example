...
func main() {
	...
	clientEcho(context, client, &p)

}

func clientEcho(context context.Context, client person.PersonServiceClient, person *person.Person) {
	person2, err := client.Echo(context, person, grpc.FailFast(true))
